...
The `queryCancellable` and `mutateCancellable` methods automatically create and manage the `CancellationToken`. The token is disposed automatically when the result future completes:
